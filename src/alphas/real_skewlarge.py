...
class real_skewlarge():
    def __init__(self, args_dict):
        self.__name = 'real_skewlarge'
    ...
    def __compute_liquidity(self, x):
        return (x['real_skewlarge']).rolling(self.__window, min_periods=self.__window, closed='left').mean()
