...
class corr_VRleadlarge():
    def __init__(self, args_dict):
        self.__name = 'corr_VRleadlarge'
    ...
    def __compute_liquidity(self, x):
        return (x['corr_VRleadlarge']).rolling(self.__window, min_periods=self.__window, closed='left').mean()
    ...
    def compute(self):
        ...
        intray_vol = dataloader.loading(
            tab_name="Intraday PV", start=self.__start, end=self.__end, fields=['code', 'corr_VPlarge', 'corr_VRlarge', 'corr_VRlaglarge', 'corr_VRleadlarge'])
