...
class corr_VRlaglarge():
    def __init__(self, args_dict):
        self.__name = 'corr_VRlaglarge'
    ...
    def __compute_liquidity(self, x):
        return (x['corr_VRlaglarge']).rolling(self.__window, min_periods=self.__window, closed='left').mean()
