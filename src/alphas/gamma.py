...
class ratio_realvarlarge():
    def __init__(self, args_dict):
        self.__name = 'ratio_realvarlarge'
    ...
    def compute(self):
        ...
        intray_vol = dataloader.loading(
            tab_name="Intraday Return", start=self.__start, end=self.__end, fields=['code', 'gamma'])
        ...
        stocks['N_ret_std'] = stocks.groupby('code').adj_close.apply(self.__compute_std)
