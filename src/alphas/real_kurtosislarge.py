...
class real_kurtosislarge():
    def __init__(self, args_dict):
        self.__name = 'real_kurtosislarge'
    ...
    def __compute_liquidity(self, x):
        return (x['real_kurtosislarge']).rolling(self.__window, min_periods=self.__window, closed='left').mean()
